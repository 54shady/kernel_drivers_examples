...
struct rk818_chip_regulator_subdev {
	int id;
...
struct rk818_chip {
	...
	int (*read)(struct rk818_chip *rk818, u8 reg, int size, void *dest);
	int (*write)(struct rk818_chip *rk818, u8 reg, int size, void *src);
...
struct rk818_chip_platform_data {
	int num_regulators;
	struct rk818_chip_regulator_subdev *regulators;
	struct battery_platform_data *battery_data;
	int irq;
	int irq_base;
	struct irq_domain *irq_domain;
...
int rk818_clear_bits(struct rk818_chip *rk818, u8 reg, u8 mask);
u8 rk818_reg_read(struct rk818_chip *rk818, u8 reg);
int rk818_reg_write(struct rk818_chip *rk818, u8 reg, u8 val);
int rk818_bulk_read(struct rk818_chip *rk818, u8 reg, int count, u8 *buf);
int rk818_bulk_write(struct rk818_chip *rk818, u8 reg, int count, u8 *buf);
